...
export const WaitlistBar = ({ onJoinClick }: WaitlistBarProps) => {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm p-3 border-t border-gray-200 flex items-center justify-between md:hidden animate-in slide-in-from-bottom-12 duration-500">
